...
extern "C"
{
  ...
  static PurplePluginInfo info = {
    ...
    (char*)"gtk-joshdreamland-pidginplus",
    (char*)"Pidgin Plus!",
    (char*)"0.0.0:0001",
    (char*)"Pidgin Plus!",
    (char*)"Pidgin Plus! Extension -- A plugin designed to bring the features of MSN Plus! to Pidgin.", 
    (char*)"Josh Ventura <JoshV10@gmail.com>",
    (char*)"http://pplus.dreamland.im/",

    plugin_load,   // Load
    plugin_unload, // Unload 
    NULL,          // Destroy

    NULL, // PidginPluginUiInfo
    NULL, // PurplePluginLoaderInfo
