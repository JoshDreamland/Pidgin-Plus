/**
 * @file   codes.h
 * @brief  Header declaring formatting codes used by various protocols,
 *         as well as unicode offsets for forced formatting.
 * 
 * @section License
 * 
 * Pidgin Plus! Plugin
...
extern const string msgplus_underline;
